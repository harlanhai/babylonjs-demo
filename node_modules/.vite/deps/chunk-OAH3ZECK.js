...
// node_modules/.pnpm/@babylonjs+core@8.2.0/node_modules/@babylonjs/core/ShadersWGSL/iblVoxelGrid3dDebug.fragment.js
var name, shader, iblVoxelGrid3dDebugPixelShaderWGSL;
var init_iblVoxelGrid3dDebug_fragment = __esm({
  "node_modules/.pnpm/@babylonjs+core@8.2.0/node_modules/@babylonjs/core/ShadersWGSL/iblVoxelGrid3dDebug.fragment.js"() {
    init_shaderStore();
    name = "iblVoxelGrid3dDebugPixelShader";
    shader = `varying vUV: vec2f;var voxelTextureSampler: sampler;var voxelTexture: texture_3d<f32>;var voxelSlabTextureSampler: sampler;var voxelSlabTexture: texture_2d<f32>;var textureSamplerSampler: sampler;var textureSampler: texture_2d<f32>;uniform sizeParams: vec4f;
...
fragmentOutputs.color=vec4f(mix(background.rgb,voxelSlab.rgb,voxelSlab.a)+voxel,1.0);}}`;
    ...
    iblVoxelGrid3dDebugPixelShaderWGSL = { name, shader };
  }
});
...
//# sourceMappingURL=chunk-OAH3ZECK.js.map
