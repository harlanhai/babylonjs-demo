...
// node_modules/.pnpm/@babylonjs+core@8.2.0/node_modules/@babylonjs/core/ShadersWGSL/iblGenerateVoxelMip.fragment.js
var name, shader, iblGenerateVoxelMipPixelShaderWGSL;
var init_iblGenerateVoxelMip_fragment = __esm({
  "node_modules/.pnpm/@babylonjs+core@8.2.0/node_modules/@babylonjs/core/ShadersWGSL/iblGenerateVoxelMip.fragment.js"() {
    init_shaderStore();
    name = "iblGenerateVoxelMipPixelShader";
    shader = `varying vUV: vec2f;var srcMip: texture_3d<f32>;uniform layerNum: i32;@fragment
...
<< 7u);fragmentOutputs.color=vec4f( f32(tex)/255.0f,0.0f,0.0f,1.0);}`;
    ...
    iblGenerateVoxelMipPixelShaderWGSL = { name, shader };
  }
});

export {
  iblGenerateVoxelMipPixelShaderWGSL,
  init_iblGenerateVoxelMip_fragment
};
//# sourceMappingURL=chunk-EBZSKGUO.js.map
