...
// node_modules/.pnpm/@babylonjs+core@8.2.0/node_modules/@babylonjs/core/Shaders/iblVoxelGrid3dDebug.fragment.js
var name, shader, iblVoxelGrid3dDebugPixelShader;
var init_iblVoxelGrid3dDebug_fragment = __esm({
  "node_modules/.pnpm/@babylonjs+core@8.2.0/node_modules/@babylonjs/core/Shaders/iblVoxelGrid3dDebug.fragment.js"() {
    init_shaderStore();
    name = "iblVoxelGrid3dDebugPixelShader";
    shader = `precision highp sampler3D;varying vec2 vUV;uniform sampler3D voxelTexture;uniform sampler2D voxelSlabTexture;uniform sampler2D textureSampler;uniform vec4 sizeParams;
...
glFragColor.rgb=mix(background.rgb,voxelSlab.rgb,voxelSlab.a)+voxel;glFragColor.a=1.0;}}`;
    ...
    iblVoxelGrid3dDebugPixelShader = { name, shader };
  }
});
...
//# sourceMappingURL=chunk-5R7FX2M7.js.map
