...
// node_modules/.pnpm/@babylonjs+core@8.2.0/node_modules/@babylonjs/core/ShadersWGSL/iblIcdf.fragment.js
var name, shader, iblIcdfPixelShaderWGSL;
var init_iblIcdf_fragment = __esm({
  "node_modules/.pnpm/@babylonjs+core@8.2.0/node_modules/@babylonjs/core/ShadersWGSL/iblIcdf.fragment.js"() {
    init_shaderStore();
    init_helperFunctions();
    name = "iblIcdfPixelShader";
...
.r;var pixelLuminance: f32=fetchLuminance(input.vUV);outputColor.z=pixelLuminance/(2.0*PI*normalization);fragmentOutputs.color=vec4( outputColor,1.0);}`;
    ...
    iblIcdfPixelShaderWGSL = { name, shader };
  }
});

export {
  iblIcdfPixelShaderWGSL,
  init_iblIcdf_fragment
};
//# sourceMappingURL=chunk-NQ7VPPVI.js.map
