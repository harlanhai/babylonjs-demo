...
// node_modules/.pnpm/@babylonjs+core@8.2.0/node_modules/@babylonjs/core/Shaders/ShadersInclude/gaussianSplattingVertexDeclaration.js
var name, shader, gaussianSplattingVertexDeclaration;
var init_gaussianSplattingVertexDeclaration = __esm({
  "node_modules/.pnpm/@babylonjs+core@8.2.0/node_modules/@babylonjs/core/Shaders/ShadersInclude/gaussianSplattingVertexDeclaration.js"() {
    init_shaderStore();
    name = "gaussianSplattingVertexDeclaration";
    shader = `attribute vec2 position;uniform mat4 view;uniform mat4 projection;uniform mat4 world;uniform vec4 vEyePosition;`;
    if (!ShaderStore.IncludesShadersStore[name]) {
      ShaderStore.IncludesShadersStore[name] = shader;
    }
    gaussianSplattingVertexDeclaration = { name, shader };
  }
});

// node_modules/.pnpm/@babylonjs+core@8.2.0/node_modules/@babylonjs/core/Shaders/ShadersInclude/gaussianSplattingUboDeclaration.js
var name2, shader2;
var init_gaussianSplattingUboDeclaration = __esm({
  "node_modules/.pnpm/@babylonjs+core@8.2.0/node_modules/@babylonjs/core/Shaders/ShadersInclude/gaussianSplattingUboDeclaration.js"() {
    init_shaderStore();
    init_sceneUboDeclaration();
    init_meshUboDeclaration();
    name2 = "gaussianSplattingUboDeclaration";
...
// node_modules/.pnpm/@babylonjs+core@8.2.0/node_modules/@babylonjs/core/Shaders/ShadersInclude/gaussianSplatting.js
var name3, shader3;
var init_gaussianSplatting = __esm({
  "node_modules/.pnpm/@babylonjs+core@8.2.0/node_modules/@babylonjs/core/Shaders/ShadersInclude/gaussianSplatting.js"() {
    init_shaderStore();
    name3 = "gaussianSplatting";
    shader3 = `#if !defined(WEBGL2) && !defined(WEBGPU) && !defined(NATIVE)
...
// node_modules/.pnpm/@babylonjs+core@8.2.0/node_modules/@babylonjs/core/Shaders/gaussianSplatting.vertex.js
var name4, shader4, gaussianSplattingVertexShader;
var init_gaussianSplatting_vertex = __esm({
  "node_modules/.pnpm/@babylonjs+core@8.2.0/node_modules/@babylonjs/core/Shaders/gaussianSplatting.vertex.js"() {
    init_shaderStore();
    ...
    init_fogVertex();
    init_logDepthVertex();
    name4 = "gaussianSplattingVertexShader";
    shader4 = `#include<__decl__gaussianSplattingVertex>
...
`;
    ...
    gaussianSplattingVertexShader = { name: name4, shader: shader4 };
  }
});
...
//# sourceMappingURL=chunk-AGGORVHP.js.map
