...
// node_modules/.pnpm/@babylonjs+core@8.2.0/node_modules/@babylonjs/core/Misc/rgbdTextureTools.js
    ...
    RGBDTextureTools = class {
      ...
      static ExpandRGBDTexture(texture) {
        ...
        const expandRGBDTexture = async () => {
          ...
          internalTexture.isReady = false;
          if (isWebGPU) {
            await import("./rgbdDecode.fragment-QQN7YSTA.js");
          } else {
            await import("./rgbdDecode.fragment-JTC42INO.js");
          }
      ...
      static async EncodeTextureToRGBD(internalTexture, scene, outputTextureType = 0) {
        if (!scene.getEngine().isWebGPU) {
          await import("./rgbdEncode.fragment-H6GKNE4S.js");
        } else {
          await import("./rgbdEncode.fragment-KWDYPCZH.js");
        }
...
// node_modules/.pnpm/@babylonjs+core@8.2.0/node_modules/@babylonjs/core/Materials/Textures/baseTexture.polynomial.js
...
// node_modules/.pnpm/@babylonjs+core@8.2.0/node_modules/@babylonjs/core/Misc/environmentTextureTools.js
...
//# sourceMappingURL=chunk-TBVJTRAA.js.map
