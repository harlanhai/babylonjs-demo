...
// node_modules/.pnpm/@babylonjs+core@8.2.0/node_modules/@babylonjs/core/ShadersWGSL/colorCorrection.fragment.js
var name, shader, colorCorrectionPixelShaderWGSL;
var init_colorCorrection_fragment = __esm({
  "node_modules/.pnpm/@babylonjs+core@8.2.0/node_modules/@babylonjs/core/ShadersWGSL/colorCorrection.fragment.js"() {
    init_shaderStore();
    name = "colorCorrectionPixelShader";
    shader = `varying vUV: vec2f;var textureSamplerSampler: sampler;var textureSampler: texture_2d<f32>;varying vUV: vec2f;var colorTableSampler: sampler;var colorTable: texture_2d<f32>;const SLICE_COUNT: f32=16.0; 
...
fn main(input: FragmentInputs)->FragmentOutputs {var screen_color: vec4f=textureSample(textureSampler,textureSamplerSampler,input.vUV);fragmentOutputs.color=sampleAs3DTexture(screen_color.rgb,SLICE_COUNT);}`;
    ...
    colorCorrectionPixelShaderWGSL = { name, shader };
  }
});

export {
  colorCorrectionPixelShaderWGSL,
  init_colorCorrection_fragment
};
//# sourceMappingURL=chunk-QNBVO4X6.js.map
