...
// node_modules/.pnpm/@babylonjs+core@8.2.0/node_modules/@babylonjs/core/Shaders/colorCorrection.fragment.js
var name, shader, colorCorrectionPixelShader;
var init_colorCorrection_fragment = __esm({
  "node_modules/.pnpm/@babylonjs+core@8.2.0/node_modules/@babylonjs/core/Shaders/colorCorrection.fragment.js"() {
    init_shaderStore();
    name = "colorCorrectionPixelShader";
    shader = `uniform sampler2D textureSampler; 
...
{vec4 screen_color=texture2D(textureSampler,vUV);gl_FragColor=sampleAs3DTexture(colorTable,screen_color.rgb,SLICE_COUNT);}`;
    ...
    colorCorrectionPixelShader = { name, shader };
  }
});
...
//# sourceMappingURL=chunk-376X5FFB.js.map
