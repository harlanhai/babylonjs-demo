...
// node_modules/.pnpm/@babylonjs+core@8.2.0/node_modules/@babylonjs/core/ShadersWGSL/screenSpaceReflection2Blur.fragment.js
var name, shader, screenSpaceReflection2BlurPixelShaderWGSL;
var init_screenSpaceReflection2Blur_fragment = __esm({
  "node_modules/.pnpm/@babylonjs+core@8.2.0/node_modules/@babylonjs/core/ShadersWGSL/screenSpaceReflection2Blur.fragment.js"() {
    init_shaderStore();
    name = "screenSpaceReflection2BlurPixelShader";
    shader = `var textureSamplerSampler: sampler;var textureSampler: texture_2d<f32>;varying vUV: vec2f;uniform texelOffsetScale: vec2f;const weights: array<f32,8>=array<f32,8>(0.071303,0.131514,0.189879,0.321392,0.452906, 0.584419,0.715932,0.847445);fn processSample(uv: vec2f,i: f32,stepSize: vec2f,accumulator: ptr<function,vec4f>,denominator: ptr<function,f32>)
...
`;
    ...
    screenSpaceReflection2BlurPixelShaderWGSL = { name, shader };
  }
});

export {
  screenSpaceReflection2BlurPixelShaderWGSL,
  init_screenSpaceReflection2Blur_fragment
};
//# sourceMappingURL=chunk-6AWWDHGY.js.map
