...
// node_modules/.pnpm/@babylonjs+core@8.2.0/node_modules/@babylonjs/core/Shaders/iblShadowVoxelTracing.fragment.js
var name, shader, iblShadowVoxelTracingPixelShader;
var init_iblShadowVoxelTracing_fragment = __esm({
  "node_modules/.pnpm/@babylonjs+core@8.2.0/node_modules/@babylonjs/core/Shaders/iblShadowVoxelTracing.fragment.js"() {
    init_shaderStore();
    name = "iblShadowVoxelTracingPixelShader";
    shader = `precision highp sampler2D;precision highp sampler3D;
#define PI 3.1415927
varying vec2 vUV;
...
gl_FragColor=vec4(shadowAccum/float(sampleWeight),specShadowAccum/float(sampleWeight),0.0,1.0);
    ...
    iblShadowVoxelTracingPixelShader = { name, shader };
  }
});

export {
  iblShadowVoxelTracingPixelShader,
  init_iblShadowVoxelTracing_fragment
};
//# sourceMappingURL=chunk-TQGXPNGT.js.map
