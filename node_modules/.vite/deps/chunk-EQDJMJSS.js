...
// node_modules/.pnpm/@babylonjs+core@8.2.0/node_modules/@babylonjs/core/ShadersWGSL/glowBlurPostProcess.fragment.js
var name, shader, glowBlurPostProcessPixelShaderWGSL;
var init_glowBlurPostProcess_fragment = __esm({
  "node_modules/.pnpm/@babylonjs+core@8.2.0/node_modules/@babylonjs/core/ShadersWGSL/glowBlurPostProcess.fragment.js"() {
    init_shaderStore();
    name = "glowBlurPostProcessPixelShader";
    shader = `varying vUV: vec2f;var textureSamplerSampler: sampler;var textureSampler: texture_2d<f32>;uniform screenSize: vec2f;uniform direction: vec2f;uniform blurWidth: f32;fn getLuminance(color: vec3f)->f32
...
fragmentOutputs.color=baseColor;}`;
    ...
    glowBlurPostProcessPixelShaderWGSL = { name, shader };
  }
});

export {
  glowBlurPostProcessPixelShaderWGSL,
  init_glowBlurPostProcess_fragment
};
//# sourceMappingURL=chunk-EQDJMJSS.js.map
