...
// node_modules/.pnpm/@babylonjs+core@8.2.0/node_modules/@babylonjs/core/ShadersWGSL/motionBlur.fragment.js
var name, shader, motionBlurPixelShaderWGSL;
var init_motionBlur_fragment = __esm({
  "node_modules/.pnpm/@babylonjs+core@8.2.0/node_modules/@babylonjs/core/ShadersWGSL/motionBlur.fragment.js"() {
    init_shaderStore();
    name = "motionBlurPixelShader";
    shader = `varying vUV: vec2f;var textureSamplerSampler: sampler;var textureSampler: texture_2d<f32>;uniform motionStrength: f32;uniform motionScale: f32;uniform screenSize: vec2f;
#ifdef OBJECT_BASED
...
`;
    ...
    motionBlurPixelShaderWGSL = { name, shader };
  }
});

export {
  motionBlurPixelShaderWGSL,
  init_motionBlur_fragment
};
//# sourceMappingURL=chunk-WT6R7KIT.js.map
