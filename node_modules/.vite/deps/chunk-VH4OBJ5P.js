...
// node_modules/.pnpm/@babylonjs+core@8.2.0/node_modules/@babylonjs/core/ShadersWGSL/ShadersInclude/intersectionFunctions.js
var name, shader;
var init_intersectionFunctions = __esm({
  "node_modules/.pnpm/@babylonjs+core@8.2.0/node_modules/@babylonjs/core/ShadersWGSL/ShadersInclude/intersectionFunctions.js"() {
    init_shaderStore();
    name = "intersectionFunctions";
    shader = `fn diskIntersectWithBackFaceCulling(ro: vec3f,rd: vec3f,c: vec3f,r: f32)->f32 {var d: f32=rd.y;if(d>0.0) { return 1e6; }
...
// node_modules/.pnpm/@babylonjs+core@8.2.0/node_modules/@babylonjs/core/ShadersWGSL/background.fragment.js
var name2, shader2, backgroundPixelShaderWGSL;
var init_background_fragment = __esm({
  "node_modules/.pnpm/@babylonjs+core@8.2.0/node_modules/@babylonjs/core/ShadersWGSL/background.fragment.js"() {
    init_shaderStore();
    init_backgroundUboDeclaration();
    init_helperFunctions();
    ...
    init_logDepthFragment();
    init_fogFragment();
    name2 = "backgroundPixelShader";
    shader2 = `#include<backgroundUboDeclaration>
...
`;
    ...
    backgroundPixelShaderWGSL = { name: name2, shader: shader2 };
  }
});

export {
  backgroundPixelShaderWGSL,
  init_background_fragment
};
//# sourceMappingURL=chunk-VH4OBJ5P.js.map
