...
} from "./chunk-B4Z2HJAL.js";
import {
  init_instancesVertex
} from "./chunk-NBPN4JFG.js";
import {
...
// node_modules/.pnpm/@babylonjs+core@8.2.0/node_modules/@babylonjs/core/ShadersWGSL/greasedLine.vertex.js
var name, shader, greasedLineVertexShaderWGSL;
var init_greasedLine_vertex = __esm({
  "node_modules/.pnpm/@babylonjs+core@8.2.0/node_modules/@babylonjs/core/ShadersWGSL/greasedLine.vertex.js"() {
    init_shaderStore();
    init_instancesDeclaration();
    init_sceneUboDeclaration();
    init_meshUboDeclaration();
    init_instancesVertex();
    name = "greasedLineVertexShader";
    shader = `#include<instancesDeclaration>
...
`;
    ...
    greasedLineVertexShaderWGSL = { name, shader };
  }
});

export {
  greasedLineVertexShaderWGSL,
  init_greasedLine_vertex
};
//# sourceMappingURL=chunk-U6WAKW3B.js.map
