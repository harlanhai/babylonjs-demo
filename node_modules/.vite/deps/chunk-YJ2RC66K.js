...
// node_modules/.pnpm/@babylonjs+core@8.2.0/node_modules/@babylonjs/core/ShadersWGSL/vrDistortionCorrection.fragment.js
var name, shader, vrDistortionCorrectionPixelShaderWGSL;
var init_vrDistortionCorrection_fragment = __esm({
  "node_modules/.pnpm/@babylonjs+core@8.2.0/node_modules/@babylonjs/core/ShadersWGSL/vrDistortionCorrection.fragment.js"() {
    init_shaderStore();
    name = "vrDistortionCorrectionPixelShader";
...
fn main(input: FragmentInputs)->FragmentOutputs {var tc: vec2f=HmdWarp(input.vUV);if (tc.x <0.0 || tc.x>1.0 || tc.y<0.0 || tc.y>1.0) {fragmentOutputs.color=vec4f(0.0,0.0,0.0,0.0);}
    ...
    vrDistortionCorrectionPixelShaderWGSL = { name, shader };
  }
});
...
//# sourceMappingURL=chunk-YJ2RC66K.js.map
