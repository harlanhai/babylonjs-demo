...
// node_modules/.pnpm/@babylonjs+core@8.2.0/node_modules/@babylonjs/core/ShadersWGSL/tonemap.fragment.js
var name, shader, tonemapPixelShaderWGSL;
var init_tonemap_fragment = __esm({
  "node_modules/.pnpm/@babylonjs+core@8.2.0/node_modules/@babylonjs/core/ShadersWGSL/tonemap.fragment.js"() {
    init_shaderStore();
    name = "tonemapPixelShader";
    shader = `varying vUV: vec2f;var textureSamplerSampler: sampler;var textureSampler: texture_2d<f32>;uniform _ExposureAdjustment: f32;
...
fragmentOutputs.color= vec4f(colour.rgb,1.0);}`;
    ...
    tonemapPixelShaderWGSL = { name, shader };
  }
});

export {
  tonemapPixelShaderWGSL,
  init_tonemap_fragment
};
//# sourceMappingURL=chunk-MA4FD3EA.js.map
