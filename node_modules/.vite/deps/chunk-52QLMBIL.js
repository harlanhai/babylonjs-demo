...
// node_modules/.pnpm/@babylonjs+core@8.2.0/node_modules/@babylonjs/core/ShadersWGSL/iblCdfy.fragment.js
var name, shader, iblCdfyPixelShaderWGSL;
var init_iblCdfy_fragment = __esm({
  "node_modules/.pnpm/@babylonjs+core@8.2.0/node_modules/@babylonjs/core/ShadersWGSL/iblCdfy.fragment.js"() {
    init_shaderStore();
    name = "iblCdfyPixelShader";
    shader = `varying vUV : vec2f;
...
fragmentOutputs.color= vec4f(cdfy,0.0,0.0,1.0);}`;
    ...
    iblCdfyPixelShaderWGSL = { name, shader };
  }
});
...
//# sourceMappingURL=chunk-52QLMBIL.js.map
